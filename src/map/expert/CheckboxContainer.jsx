...
const CheckboxContainer = () => {
  ...
  const showList = checks.map((data, i) => (
  ...
  const handleOnChanged = (e) => {
    ...
    {
      //checks.splice(checks.indexOf(e.target.value), 1);
      setChecks(checks.filter((data) => data !== e.target.value));
    }
  }
  ...
  return (
    <div>
      <label>
        <input type="checkbox" value="C" onChange={handleOnChanged}/>
        <span>C</span>
      </label>
      <label>
        <input type="checkbox" value="Java" onChange={handleOnChanged}/>
        <span>Java</span>
      </label>
      <label>
        <input type="checkbox" value="JS" onChange={handleOnChanged}/>
        <span>JS</span>
      </label>
      <ul>{showList}</ul>
    </div>
